...
/**
 * Test class for BDHelper.
 *
 * @package     BabDev.UnitTest
 * @subpackage  Helper
 * @since       1.0
 */
class BDHelperTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	/**
	 * Tests the BDHelper::ipInRange method.
	 *
	...
	{
		$this->assertThat(
			BDHelper::ipInRange($testIp, $validIps, $type),
			$this->equalTo($result)
		);
	}

	/**
	 * Tests the BDHelper::ipInRange method for a bad type parameter
	 *
	 * @return  void
	 *
	 * @since              1.0
	...
	{
		BDHelper::ipInRange('192.168.0.32', array('192.168.0.0/24'), 'decimal');
	}
}
